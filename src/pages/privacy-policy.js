  ...
  return (
    <Layout>
      ...
      <ContentWrapper>
        ...
        <p>
          <small>Last updated March 05, 2019</small>
        </p>
        <p>
          Thank you for choosing to be part of our community at kalm42, Inc. We are committed to protecting your
          personal information and your right to privacy. If you have any questions or concerns about our policy, or our
          practices with regards to your personal information, please contact us at me@kalm42.com.
        </p>
        <p>
          When you visit our website https://kalm42.com, and use our services, you trust us with your personal
          information. We take your privacy very seriously. In this privacy notice, we describe our privacy policy. We
          seek to explain to you in the clearest way possible what information we collect, how we use it and what rights
          you have in relation to it. We hope you take some time to read through it carefully, as it is important. If
          there are any terms in this privacy policy that you do not agree with, please discontinue use of our Sites and
          our services.
        </p>
        <p>
          This privacy policy applies to all information collected through our website (such as https://kalm42.com),
          and/or any related services, sales, marketing or events (we refer to them collectively in this privacy policy
          as the "Sites"). Please read this privacy policy carefully as it will help you make informed decisions about
        ...
        <nav>
          <ol>
            <li>
              <a href="#infocollect">What Information Do We Collection?</a>
            </li>
            <li>
              <a href="#infouse">How do we use your information?</a>
            </li>
            <li>
            ...
            <li>
              <a href="#googlemaps">Do we use google maps?</a>
            </li>
            <li>
            ...
            <li>
              <a href="#privacyrights">What are your privacy right?</a>
            </li>
            <li>
            ...
            <li>
              <a href="#contact">How can you contact us about this policy?</a>
            </li>
          </ol>
        </nav>
        <h3 id="infocollect">1. What Information Do We Collection?</h3>
        ...
        <p>
          We automatically collect certain information when you visit, use or navigate the Sites. This information does
        ...
        <p>
          This information is primarily needed to maintain the security and operation of our Sites, and for our internal
          analytics and reporting purposes. Like many businesses, we also collect information through cookies and
        ...
        <p>
          ...
          well as from other third parties. Examples of the information we receive from other sources include: social
          media profile information ; marketing leads and search results and links, including paid listings (such as
          sponsored links).
        </p>
        <h3 id="infouse">2. How do we use your information?</h3>
        <p>
          In Short: We process your information for purposes based on legitimate business interests, the fulfillment of
          our contract with you, compliance with our legal obligations, and/or your consent.
        </p>
        <p>We use personal information collected via our Sites for a variety of business purposes described below.</p>
        <p>
        ...
        <p>We use the information we collect or receive: For other Business Purposes.</p>
        <p>
          We may use your information for other Business Purposes, such as data analysis, identifying usage trends,
          determining the effectiveness of our promotional campaigns and to evaluate and improve our Sites, products,
        ...
        <p>
          ...
          involved. More specifically, we may need to process your data or share your personal information in the
          following situations: Vendors, Consultants and Other Third-Party Service Providers.
        </p>
        <p>
        ...
        <p>
          We may allow selected third parties to use tracking technology on the Sites, which will enable them to collect
          data about how you interact with the Sites over time. This information may be used to, among other things,
        ...
        <h3 id="whoshare">4. Who will your information be shared with?</h3>
        ...
        <p>
          We have categorized each party so that you may be easily understand the purpose of our data collection and
          processing practices. If we have processed your data based on your consent and you wish to revoke your
          consent, please contact us.
        </p>
        <ul>
          <li>Content Optimization: Google Site Search</li>
          <li>Web and Mobile Analytics Google Analytics</li>
          <li>Website Hosting Netlify</li>
          <li>Website Performance Monitoring Sentry</li>
        </ul>
        ...
        <h3 id="googlemaps">6. Do we use google maps?</h3>
        <p>In Short: Yes, we use Google Maps for the purpose of providing better service.</p>
        <p>
          This website, mobile application, or Facebook application uses Google Maps APIs. You may find the Google Maps
        ...
        <p>
          ...
          longer than 2 years. When we have no ongoing legitimate business need to process your personal information, we
        ...
        <p>
          ...
          transmission of personal information to and from our Sites is at your own risk. You should only access the
        ...
        <p>
          ...
          minor dependent’s use of the Sites. If we learn that personal information from users less than 18 years of age
        ...
        <h3 id="privacyrights">10. What are your privacy right?</h3>
        <p>
          In Short: You may review, change, or terminate your account at any time. If you are resident in the European
          Economic Area and you believe we are unlawfully processing your personal information, you also have the right
        ...
        <p>
          ...
          your request in writing to us using the contact information provided below. If you are under 18 years of age,
          reside in California, and have a registered account with the Sites, you have the right to request removal of
          unwanted data that you publicly post on the Sites. To request removal of such data, please contact us using
          the contact information provided below, and include the email address associated with your account and a
          statement that you reside in California. We will make sure the data is not publicly displayed on the Sites,
          but please be aware that the data may not be completely or comprehensively removed from our systems.
        </p>
        <h3 id="policyupdates">13. Do we make updates to this policy?</h3>
        ...
        <p>
          If you have questions or comments about this policy, you may email us at me@kalm42.com or by post to: kalm42,
          Inc 2184 Channing Way # 417, Idaho Falls, ID 83404 Idaho Falls, ID 83404 United States
        </p>
      </ContentWrapper>
    </Layout>
  )
