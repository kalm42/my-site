  ...
  return (
    <Layout>
      ...
      <p>
        ...
        concerns about our policy, or our practices with regards to your personal information,
        please contact us at me@kalm42.com.
      </p>
      <p>
        When you visit our website https://kalm42.com, and use our services, you trust us with your
        ...
        in this privacy policy that you do not agree with, please discontinue use of our Sites and
        our services.
      </p>
      <p>
      ...
      <p>
        We may use your information for other Business Purposes, such as data analysis, identifying
      ...
      <p>
        We have categorized each party so that you may be easily understand the purpose of our data
      ...
      <p>
        ...
        require us keeping your personal information for longer than 2 years. When we have no
        ongoing legitimate business need to process your personal information, we will either delete
        or anonymize it, or, if this is not possible (for example, because your personal information
      ...
      <p>
        In Short: You may review, change, or terminate your account at any time. If you are resident
      ...
      <p>
        ...
        writing to us using the contact information provided below. If you are under 18 years of
        age, reside in California, and have a registered account with the Sites, you have the right
        to request removal of unwanted data that you publicly post on the Sites. To request removal
        of such data, please contact us using the contact information provided below, and include
        the email address associated with your account and a statement that you reside in
        California. We will make sure the data is not publicly displayed on the Sites, but please be
      ...
      <p>
        If you have questions or comments about this policy, you may email us at me@kalm42.com or by
        post to: kalm42, Inc 2184 Channing Way # 417, Idaho Falls, ID 83404 Idaho Falls, ID 83404
        United States
      </p>
    </Layout>
  )
